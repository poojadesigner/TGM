...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-53262106-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-53262106-4');
</script>
     <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
			...
			/*	if(isset($beeseo_options['free_consultation_button_text']) && $beeseo_options['free_consultation_button_text'] && $header_style!='2' && $header_style!='1') : ?>
				...
				<?php endif; */?>
                                ...
                                <ul class="loging-class pull-right">
                                   ...
                                   <ul class="sub-menu">
                                       <li><a href="/login/">outbound Calendar</a></li>
                                       <li><a href="https://portal.client360services.com/tgmarketing/Index.asp">inbound portal</a></li>
                                   </ul>
                                    </li>
                                </ul>
				...
				<ul class="top-contact-infos nav nav-pills <?php echo esc_html( $contactClass ); ?>" >
				 <?php if(isset($beeseo_options['topbar_email']) && $beeseo_options['topbar_email']) : ?>
					<li class="tp"><a href="mailto:<?php echo esc_attr($beeseo_options['topbar_email']); ?>"><i class="fa fa-envelope"></i><?php echo esc_html($beeseo_options['topbar_email']); ?></a></li>
				<?php endif; ?>
				<?php if(isset($beeseo_options['topbar_email']) && $beeseo_options['topbar_email']) : ?>
					<li class="tp"><a href="tel:<?php echo esc_attr($beeseo_options['topbar_phone']) ?>"><i class="fa fa-phone-square"></i><?php echo esc_html($beeseo_options['topbar_phone']); ?></a></li>
				<?php endif; ?>
				...
				<?php endif; ?>
									<li class="careers"><a class="career-green" href="http://tgmarketingusa.com/careers/" target="_blank">CAREERS</a></li>
